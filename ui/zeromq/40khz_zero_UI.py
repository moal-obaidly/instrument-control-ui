                ...
                try:
                    ...
                    if topic == b"experiment/data":
                        for i in range (0,len(payload),8) : 
                            ...
                            value,seq = struct.unpack('HI',payload[i:i+8]) 
                            if seq not in self.received_seqs:
                                ...
                                if self.old_seq != 0:
                                    if seq < self.old_seq:
                                        ...
                                        self.ordering = False
                                self.checksum += sum(payload[i:i+8])
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.zmq_sub_client = zmq_Subscriber("tcp://192.168.1.34:6001","experiment/")#34 for rpi5, 33 for rpi ethernet, 82 for pi4 # tailscale: 100.113.46.57 #old dns:5556
