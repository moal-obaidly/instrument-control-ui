...
# MQTT setup
broker = "100.106.113.72" #.36 for laptop, .82 for rpi4
port = 1883
        ...
        #     time.sleep(0.001) 
            ...
            if len(buffered_data) >= batch_size and running:
                ...
                if client.is_connected():
                    ...
                    zmq_pub_socket.send_multipart([b"experiment/data", multi_payload])
            ...
            #         time.sleep(0.01)
                ...
                if client.is_connected():
                    ...
                    zmq_pub_socket.send_multipart([b"experiment/data", payload])   
